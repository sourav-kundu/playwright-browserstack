...
(async () => {
  ...
  */
  ...
  const context = await browser.newContext({...devices['iPhone 11 Pro']});  // Complete list of devices - https://github.com/microsoft/playwright/blob/master/src/server/deviceDescriptors.js
